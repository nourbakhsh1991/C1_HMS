...
namespace BMS.Api.Controllers
{
    ...
    public class MapController : ControllerBase
    {
        ...
        public MapController(IFileService fileService, IMediator mediator)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> PostAsync(MMap mMap)
        {
            try
            {
                var isAuthorized = await _mediator.Send(new GetAuthorizationCommand
                ...
                var updateResult = await _mediator.Send(new UpdateMapCommand { Map = mMap.GetBase() });
